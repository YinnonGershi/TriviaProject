...
class playAgain {
	...
	void _playAgain() {
		...
		driver.findElement(By.xpath("//*[@id=\"markpage\"]/center/button[1]")).click(); // PRESSING ON 'Try Again' BUTTON
		
		if (driver.getPageSource().contains("Test") == false) {
			fail("ERROR");
		}
	}
