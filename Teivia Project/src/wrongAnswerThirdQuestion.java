...
class wrongAnswerThirdQuestion {

	@Test
	void wrongAnswerThirdQuestion1 () {

		// in this function i will clarify if 'Failed' is the result 
		// when wrong answers are marked at the THIRD question ONLY
		...
		if (driver.getPageSource().contains("element")) {
			...
			driver.findElement(By.xpath("//*[@id=\"0\"]/input[2]")).click(); // MARKING THE SECOND ANSWER INSTED OF THE RIGHT ONE (THE FIRST)
			driver.findElement(By.xpath("//*[@id=\"btnnext\"]")).click();
		}
	...
	void wrongAnswerSecondQuestion2 () {
		...
		if (driver.getPageSource().contains("element")) {
			...
			driver.findElement(By.xpath("//*[@id=\"0\"]/input[3]")).click(); // MARKING THE THIRD ANSWER INSTED OF THE RIGHT ONE (THE FIRST)
			driver.findElement(By.xpath("//*[@id=\"btnnext\"]")).click();
		}
	...
	void wrongAnswerSecondQuestion3 () {
		...
		if (driver.getPageSource().contains("element")) {
			...
			driver.findElement(By.xpath("//*[@id=\"0\"]/input[4]")).click(); // MARKING THE FORTH ANSWER INSTED OF THE RIGHT ONE (THE FIRST)
			driver.findElement(By.xpath("//*[@id=\"btnnext\"]")).click();
		}
