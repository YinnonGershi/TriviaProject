...
class SanityInFirefoxDriver {

	System.setProperty("webdriver.gecko.driver", "C:\\geckoDriver\\geckodriver-v0.26.0-win64");
	WebDriver objDriver = new FirefoxDriver();

	a = driver.get("https://svcollegetest.000webhostapp.com"); // open Trivia home page
	...
	// ending the game if succeed only
