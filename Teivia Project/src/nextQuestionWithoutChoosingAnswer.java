...
class nextQuestionWithoutChoosingAnswer {

	@Test
	void nextToSecondQuestionWithoutChooseAnswer1 () {

		// in this function i will clarify if the function 
		// of 'Next!' is not working at the FIRST question when 
		// nun of the answers were chosen
		...
		// and NOT marking the any answer
		if (driver.getPageSource().contains("capital")) {

			//driver.findElement(By.xpath("//*[@id=\"2\"]/input[3]")).click(); // NOTE THAT IT DIDN'T CHOOSE THE ANSWER
			driver.findElement(By.xpath("//*[@id=\"btnnext\"]")).click(); // pressing on NEXT button
	...
	@Test
	void nextToThirdQuestionWithoutChooseAnswer1 () {

		// in this function i will clarify if the function 
		// of 'Next!' is not working at the SECOND question when 
		// nun of the answers were chosen
		...
		if (driver.getPageSource().contains("Moon")) {
			...
			//driver.findElement(By.xpath("//*[@id=\"1\"]/input[2]")).click(); // NOTE THAT IT DIDN'T CHOOSE THE ANSWER
			driver.findElement(By.xpath("//*[@id=\"btnnext\"]")).click();

			if (driver.getPageSource().contains("table") == true) {
				fail("ERROR");
			}
			else {
				driver.close();
	...
	@Test
	void nextToEndGameWithoutChooseAnswer1() {

		// in this function i will clarify if the function 
		// of 'Next!' is not working at the THIRD question when 
		// nun of the answers were chosen
		...
		if (driver.getPageSource().contains("element")) {
			...
			// driver.findElement(By.xpath("//*[@id=\"0\"]/input[1]")).click(); // NOTE THAT IT DIDN'T CHOOSE THE ANSWER
			driver.findElement(By.xpath("//*[@id=\"btnnext\"]")).click();
			driver.switchTo().alert().accept();

			if (driver.getPageSource().contains("element") == false) {
				fail("ERROR");
			}
			else {
				driver.close();
