...
class sharingAtFacebook {


	// in this function i'm going to clarify if 
	// it is possible to share the result on facebook 

	@Test
	void _sharingAtFacebook() {
		...
		driver.findElement(By.xpath("//*[@id=\"fackBook2\"]/img")).click(); // pressing on 'Share on facebook'
		driver.switchTo().alert().accept(); // dismiss the pop-up alert  

		if (driver.getCurrentUrl() != "http://www.facebook.con") {
