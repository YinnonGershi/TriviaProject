...
class wrongAnswerSecondQuestion {

	@Test
	void wrongAnswerSecondQuestion1 () {

		// in this function i will clarify if 'Failed' is the result 
		// when wrong answers are marked at the SECOND question ONLY
		...
		if (driver.getPageSource().contains("Moon")) {
			...
			driver.findElement(By.xpath("//*[@id=\"1\"]/input[1]")).click(); // MARKING THE FIRST ANSWER INSTED OF THE RIGHT ONE (THE SECOND)
			driver.findElement(By.xpath("//*[@id=\"btnnext\"]")).click();
		} 									
	...
	//------------------------------------------------------------------------------------------------------
	// testing the third answer of the first question 

	@Test
	void wrongAnswerSecondQuestion2 () {
		...
		if (driver.getPageSource().contains("Moon")) {
			...
			driver.findElement(By.xpath("//*[@id=\"1\"]/input[3]")).click(); // MARKING THE THIRD ANSWER INSTED OF THE RIGHT ONE (THE SECOND)
			driver.findElement(By.xpath("//*[@id=\"btnnext\"]")).click();
		} 							
	...
	@Test
	void wrongAnswerSecondQuestion3 () {
		...
		if (driver.getPageSource().contains("Moon")) {
			...
			driver.findElement(By.xpath("//*[@id=\"1\"]/input[4]")).click(); // MARKING THE FORTH ANSWER INSTED OF THE RIGHT ONE (THE SECOND)
			driver.findElement(By.xpath("//*[@id=\"btnnext\"]")).click();
		} 
