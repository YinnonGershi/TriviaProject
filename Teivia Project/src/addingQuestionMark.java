...
class addingQuestionMark {

	@Test
	public void addingQuestionMarkFirstOuestion () {

		// in this function i will clarify if the function 
		// adding question mark automatically is working at the FIRST question 
		...
		TextBoxQuestion1.sendKeys("What is the first element in periodic table"); // NOTE THAT QOESTION MARK IS MISSING 
		...
		// finding the specific question that i want to check  
		if (driver.getPageSource().contains("What is the first element in periodic table?") == false) {
	...
	@Test
	void addingQuestionMarkSecondOuestion () {

		// in this function i will clarify if the function 
		// adding question mark automatically is working at the SECOND question 
		...
		WebElement TextBoxQuestion2 = driver.findElement(By.name("question"));
		TextBoxQuestion2.click();
		TextBoxQuestion2.sendKeys("Which country was the first to reach to the Moon"); // NOTE THAT QOESTION MARK IS MISSING 
		...
		// finding the specific question that i want to check  
		if (driver.getPageSource().contains("Which country was the first to reach to the Moon?") == true) {
			driver.close();
		} 
		else {
			fail("ERROR");
	...
	@Test
	void addingQuestionMarkThirdOuestion3 () {

		// in this function i will clarify if the function 
		//  adding question mark automatically is working at the THIRD question 
		...
		WebElement TextBoxQuestion3 = driver.findElement(By.xpath("//*[@id=\"myform1\"]/div/div/div/input"));
		TextBoxQuestion3.click();
		TextBoxQuestion3.sendKeys("What is the capital city of Austria"); // NOTE THAT QOESTION MARK IS MISSING
		...
		// finding a specific Word that is unique to each question
		// and marking the right answer and pressing on next button
		if (driver.getPageSource().contains("What is the capital city of Austria?") == true) {
			driver.close();
		}
