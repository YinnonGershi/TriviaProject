...
class noneOfTheAnswersAreMarked {

	@Test
	void _noneOfTheAnswersAreMarkedFirstQuestion() {

		// in this function i will clarify if one of the answers 
		// is marked when first appear at the FIRST question
		...
		if (driver.getPageSource().contains("capital")) {
			...
			if (driver.findElement(By.xpath("//*[@id=\"2\"]/input[1]")).isSelected() == true || // checking if the FIRST answer is marked
					driver.findElement(By.xpath("//*[@id=\"2\"]/input[2]")).isSelected() == true || // checking if the SECOND answer is marked
					driver.findElement(By.xpath("//*[@id=\"2\"]/input[3]")).isSelected() == true || // checking if the THIRD answer is marked
					driver.findElement(By.xpath("//*[@id=\"2\"]/input[4]")).isSelected() == true  // checking if the FORTH answer is marked
					) {
				fail("ERROR");
			}
			else {
	...
	@Test
	void _noneOfTheAnswersAreMarkedSecondQuestion() {

		// in this function i will clarify if one of the answers 
		// is marked when first appear at the SECOND question
		...
		// finding a specific Word that is unique to each question
		// and marking the right answer and pressing on next button
		if (driver.getPageSource().contains("capital")) { // continue to the SECOND question
		...
		if (driver.getPageSource().contains("Moon")) {
			...
			if (
					driver.findElement(By.xpath("//*[@id=\"1\"]/input[1]")).isSelected() == true || // checking if the FIRST answer is marked
					driver.findElement(By.xpath("//*[@id=\"1\"]/input[2]")).isSelected() == true || // checking if the SECOND answer is marked
					driver.findElement(By.xpath("//*[@id=\"1\"]/input[3]")).isSelected() == true || // checking if the THIRD answer is marked
					driver.findElement(By.xpath("//*[@id=\"1\"]/input[4]")).isSelected() == true    // checking if the FORTH answer is marked
					) {						
				fail("ERROR");
			}
			else {
	...
	@Test
	void _noneOfTheAnswersAreMarkedThirdQuestion() {

		// in this function i will clarify if one of the answers 
		// is marked when first appear at the THIRD question
		...
		if (driver.getPageSource().contains("Moon")) { // continue to the THIRD question
		...
		if (driver.getPageSource().contains("element")) {
			...
			if (
					driver.findElement(By.xpath("//*[@id=\"0\"]/input[1]")).isSelected() == true || // checking if the FIRST answer is marked
					driver.findElement(By.xpath("//*[@id=\"0\"]/input[2]")).isSelected() == true || // checking if the SECOND answer is marked
					driver.findElement(By.xpath("//*[@id=\"0\"]/input[3]")).isSelected() == true || // checking if the THIRD answer is marked
					driver.findElement(By.xpath("//*[@id=\"0\"]/input[4]")).isSelected() == true    // checking if the FORTH answer is marked
					) {						
				fail("ERROR");
			}
			else {
